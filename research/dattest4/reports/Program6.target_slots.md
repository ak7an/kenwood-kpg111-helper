# Candidate Record Probe: Program6.dat

- Dominant payload XOR to normalize modified file: `0x4a`
...
- normalized modified `0x00015340`
  - hex: `e1 59 4c 51 4b 4e 3e 57 5a 3e 2e 2e 2d 2f 1e e1 e1 e1 e1 56 22 e1 e1 e1 e1 e1 e1 e1 e1 e1 e1 e1`
  - raw printable: `.YLQKN>WZ>..-/.....V"...........`
  - bytes `+1..+14` XOR `0x1e`: `GROUP ID 0031`
  - bytes `+19..+20`: `56 22`
  - bytes `+19..+20` XOR `0x1e`: `48 3c` LE=15432 BE=18492
