# Candidate Record Probe: Program4.dat

- Dominant payload XOR to normalize modified file: `0x00`
...
- normalized modified `0x000105a0`
  - hex: `e0 57 7a 73 73 70 1f 1f 1f 1f 1f 1f 1f 1f 1f e0 e0 e0 e0 79 43 e0 e0 e0 e0 e0 e0 e0 e0 e0 e0 e0`
  - raw printable: `.Wzssp.............yC...........`
  - bytes `+1..+14` XOR `0x1f`: `Hello`
  - bytes `+19..+20`: `79 43`
  - bytes `+19..+20` XOR `0x1f`: `66 5c` LE=23654 BE=26204
...
- normalized modified `0x000150a0`
  - hex: `e0 58 70 70 7b 7d 66 7a 1f 1f 1f 1f 1f 1f 1f e0 e0 e0 e0 2f 5f e0 e0 e0 e0 e0 e0 e0 e0 e0 e0 e0`
  - raw printable: `.Xpp{}fz.........../_...........`
  - bytes `+1..+14` XOR `0x1f`: `Goodbye`
  - bytes `+19..+20`: `2f 5f`
  - bytes `+19..+20` XOR `0x1f`: `30 40` LE=16432 BE=12352
